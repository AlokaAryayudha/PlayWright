...
export class DeliveryDetails{
    constructor (page){
        ...
        this.savedAddressCounty = page.locator('[data-qa="saved-address-country"]')
    ...
    saveDetails = async () => {
        ...
        await this.savedAddressCounty.first().waitFor()
        expect (await this.savedAddressCounty.first().innerText()).toBe(await this.countryDropDown.inputValue())
